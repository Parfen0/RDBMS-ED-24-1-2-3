...
VALUES
(1, 'Валентина', 'Ярмоленко', '2024-06-10'),
(2, 'Матвій','Приходько', '2024-07-11'),
(3, 'Вікторія','Гриценко','2024-08-12');
...
UPDATE Students SET Email='valentina.yarmolenko@gmail.com' WHERE StudentId=1;
UPDATE Students SET Email='matvii.prykhodko@gmail.com' where StudentId=2;
UPDATE Students SET Email='viktoria.hrytsenko@gmail.com' WHERE StudentId=3;
