...
CREATE TABLE Courses (
 ...
 INSERT INTO Students(StudentID, FirstName, LastName, EnrollmentDate)
  VALUES 
        (1, 'Володимир', 'Щербаков', '2020-08-28'),
        (2, 'Наталя', 'Ігнатенко', '2023-03-22'),
        (3, 'Петро', 'Котенко', '2021-10-10');

INSERT INTO Courses (CourseID, CourseName, CourseDescription, Credits)
 VALUES (101, 'Mathematics', 'Basic concepts of algebra and calculus', 3),
       (102, 'Physics', 'Introduction to mechanics and thermodynamics', 4),
       (103, 'Computer Science', 'Fundamentals of programming and algorithms', 5);
