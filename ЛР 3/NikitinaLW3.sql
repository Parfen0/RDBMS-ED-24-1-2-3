...
INSERT INTO Students6 (StudentId, FirstName, LastName, EnrollmentDate)
VALUES
(1, 'Богдан', 'Ажнюк', '2024-08-10'),
(2, 'Марія','Берлінська', '2024-08-11'),
(3, 'Андрій','Безсало','2024-08-13');
...
ALTER TABLE Students6 ADD Email NVARCHAR(50);
ALTER TABLE Courses ADD Department NVARCHAR(100);

/*TRUNCATE TABLE Students;
TRUNCATE TABLE Courses;*/
UPDATE Students6 SET Email='bogdan.Azhnyuk@gmail.com' WHERE StudentId=1;
UPDATE Students6 SET Email='mariia.berlin@gmail.com' where StudentId=2;
UPDATE Students6 SET Email='andriy.Bezsalo@gmail.com' WHERE StudentId=3;
