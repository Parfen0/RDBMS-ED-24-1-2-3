...
VALUES
(1, 'Olesia', 'Shevchenko', '2024-10-08'),
(2, 'Sergey','Radchenko', '2024-01-09'),
(3, 'Maria','Kondratenko','2024-03-02');
);

INSERT INTO Courses(CourseId, CourseName, CourseDescription, Credits)
VALUES
(125, 'Кібербезпека та захист інформації','Спеціальність кібербезпека...','240'),
(081, 'Право','Спеціальність право...','240'),
(221, 'Стоматологія', 'Спеціальнвсть стоматологія...','240');
...
UPDATE Students SET Email='olesiashevchenko@gmail.com' WHERE StudentId=1;
UPDATE Students SET Email='sergeyradchenko@gmail.com' where StudentId=2;
UPDATE Students SET Email='mariakondratenko@gmail.com' WHERE StudentId=3;
UPDATE Courses SET Department='Кафедра Кібербезпеки та захист інформації' WHERE CourseId=073;
UPDATE Courses SET Department='Кафедра права' WHERE CourseId=081;
UPDATE Courses SET Department='Кафедра стоматології' WHERE CourseId=241;
SELECT* 
FROM [dbo].[Students];
