...
VALUES
(1, 'Олександр', 'Петров', '2004-06-19'),
(2, 'Марія', 'Іваненко', '2007-05-27'),
(3, 'Василь', 'Коваленко', '2005-09-13');
INSERT INTO Courses(CourseID, CourseName, CourseDescription, Credits)
VALUES
(073, 'Міжнародний менеджмент', 'Спеціальність міжнародний менеджмент...', '220'),
(035, 'Філологія', 'Спеціальність філологія...', '220'),
(053, 'Психологія', 'Спеціальність психологія...', '220');
SELECT*
FROM [dbo].[Students];
SELECT*
FROM [dbo].[Courses];
...
UPDATE Students SET Email='oleksandr.petr0v@gmail.com' WHERE StudentID=1;
UPDATE Students SET Email='maria.ivanenko0@gmail.com' WHERE StudentID=2;
UPDATE Students SET Email='vasily.k0valenko@gmail.com' WHERE StudentID=3;
UPDATE Courses SET Department='Кафедра менеджменту' WHERE CourseID=073;
UPDATE Courses SET Department='Кафедра філології' WHERE CourseID=035;
UPDATE Courses SET Department='Кафедра психології' WHERE CourseID=053;
