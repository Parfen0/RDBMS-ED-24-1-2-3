...
VALUES 
(1, 'Artem', 'Panin', '2024-08-06'),
(2, 'Vladislav', 'Bychko', '2024-09-010'),
(3, 'Diana', 'Rudenko', '2022-10-10');

INSERT INTO Courses (CourseID, CourseName, CourseDescription, Credits)
VALUES 
(1, 'Mathematics', 'Курс з математики', 10),
(2, 'Economiks', 'Курс з економіки', 8),
(3, 'English', 'Курс з англійскої мови', 8);
