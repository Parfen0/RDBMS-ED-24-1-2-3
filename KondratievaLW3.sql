...
VALUES 
	...
	INSERT INTO Courses (StudentID, FirstName, LastName, DateOfBirth)
VALUES 
    (1, '?????????', '??????', '2000-05-15'),
    (2, '?????', '????????', '2001-03-22'),
    (3, '??????', '?????????', '1999-10-10');
...
ALTER Department 
 ...
 ALTER TABLE ContactInfo DROP COLUMN University;
	...
	SALES_ORDER_ID -- ?????????? ????????????? ?????????? - ????? ??? ???????? ??????? - ???? ???? ?????? ??? 2147483647
REVISION_NUMBER -- ????????? ??? ??????????? ????? ?? ??????????? - ????? ??? ???????? ??????? - ?? ?????? 255
ORDER_DATE -- ???? ? ??? ????????? ?????????? - ???? ? ???
DUE_DATE -- ???? ???????? ?????????? - ????
SHIP_DATE -- ???????? ???? ???????? ?????????? - ????
ONLINE_ORDER_FLAG -- 0 = ?????????? ???? ???????? ??????????. 1 = ?????????? ???? ???????? ?????? - ????? ??? ???????? ??????? - ?? ?????? 1
CUSTOMER_ID -- ?????????? ????????????? ???????, ???? ???????? ?????????? - ????? ??? ???????? ??????? - ?? ?????? 2147483647
SALES_PERSON_ID -- ?????????? ????????????? ?????????????, ???? ?????? ?????????? - ????? ??? ???????? ??????? - ?? ?????? 2147483647
TERRITORY_ID -- ?????????? ????????????? ????????? - ????? ??? ???????? ??????? - ?? ?????? 2147483647
SUB_TOTAL -- ???????? ???? ?????????? - ??????? ???????? - ???? ???? ?????? ??? 214748.3647
TAX_AMT -- ???????? ???? ???????? - ??????? ???????? - ?? ?????? 214748.3647
FREIGHT -- ???? ???????? - ??????? ???????? - ?? ?????? 214748.3647
MODIFIED_DATE -- ???? ? ??? ????????? ????? ?????
...
VALUES (43659, 11, '1753-01-01 00:00:00.000', '2011-06-12', '2011-06-07', 0, 29825,	279, 5,	184590.1346, 1971.5149	,616.0984	        ,'2011-06-07 00:00:00.000'),
       ...
       (43678,  8, '2011-05-31 00:00:00.000', '2011-06-12', '2011-06-07', 0, 29889,	281, 4,	9799.9243	, 942.074	,294.3981	,'2011-06-07 00:00:00.000');
	       ...
	       ALTER TABLE ContactInfo DROP COLUMN SALES


		       ALTER TABLE ContactInfo DROP COLUMN SHOP
